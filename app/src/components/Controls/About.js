...
const eduMeetUrl='https://www.elitech.net.in';
const About = ({
	aboutOpen,
	handleCloseAbout,
	classes
		...
		>
			...
			<DialogContent dividers>
				<DialogContentText paragraph>
					Elitech Video Conference is a startup project which is aimed
					to give employees of Elitech Machinery Pvt. Ltd. the capability
					to connect wirelessly for virtual meetings.
					This project is based on the eduMeet and MediaSoup libraries
					under the license from MIT.
				</DialogContentText>
				<DialogContentText paragraph>
					Elitech Machinery Pvt. Ltd. is a leading manufacturere of
					automatic colour dispensing systems in India having it's
					registered office at-
					E-2, Shree Rajlaxmi Hi-Tech Textile Park, Sonale Village
					Bhivandi, Maharashtra, India
					Pincode- 421302
				</DialogContentText>
