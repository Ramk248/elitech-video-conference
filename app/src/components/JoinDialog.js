		...
		<div className={classes.root}>
			...
			>
				<DialogTitle
					...
					loggedIn={loggedIn}
				>
					<center>{ window.config.title ? window.config.title : 'Elitech Video Conference' }</center>
					<hr />
				</DialogTitle>
				<DialogContent>
					<DialogContentText gutterBottom align="center">
						<FormattedMessage
							id='room.aboutToJoin'
							defaultMessage='You are about to join a video conference'
						/>
					</DialogContentText>

					<DialogContentText variant='h6' gutterBottom align='center' style={{color:'red'}}>
						<FormattedMessage
							id='room.roomId'
					...
					<DialogContentText gutterBottom align="center">
						<FormattedMessage
							id='room.setYourName'
							defaultMessage={
								`Set your name for the participation, 
					...
					{!room.inLobby && room.overRoomLimit &&
						<DialogContentText className={classes.red} variant='h6' gutterBottom align="center">
							<FormattedMessage
